...
2) ОПИСАНИЕ — 1-2 предложения по-русски: какие темы и что тренируется.
   Пометка «Буквы: …» — ТОЛЬКО если урок целенаправленно тренирует НАПИСАНИЕ букв:
   задания вида «Schreiben Sie J j Y y» или серия слов на одно буквосочетание (Pfanne,
   Pflanze, Pferd → Pf). Буква — это одна буква или сочетание 2-3 букв (Pf, Sch, Ö, J).
   Слова (die, sehen, machen) буквами НЕ являются — их в пометку писать НЕЛЬЗЯ.
   Обычному уроку без буквенных заданий пометка не нужна вовсе.
