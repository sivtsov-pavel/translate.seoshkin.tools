...
// Сколько карточек держим на телефоне про запас.
//
// Было 8 — мало: за один заход человек проходит их целиком и упирается в конец ленты
// (Павел, 25.08.2026). Двадцать — это уже несколько подходов подряд и приличный запас
// на случай отсутствия сети.
export const CARDS_AHEAD = 20
