...
Придумай название темы на ${langName} — одно-два слова, КОНКРЕТНО по содержанию этих слов
(«Kochen», «Beim Arzt», «Einkaufen», «Wohnung»). Общие слова вроде «Alltag», «Alltagssprache»,
«Deutsch lernen» НЕ подходят: по такому названию нельзя понять, о чём набор. Добавь эмодзи темы.
