...
function ratio(a, b) {
  ...
  // Ограничение по длине обязательно: на коротких словах подстрока — это почти всё слово,
  // и «да» внутри «дас» давало 0.9, то есть «отлично» за другое слово. Правило применимо,
  // когда короткая часть сама по себе весома (≥4 символов) либо длины почти равны.
  // Порог именно 4: «да» внутри «дас» отличается на одну букву, но это ДРУГОЕ слово,
  // а «tschüss» внутри «tschüss zusammen» — то самое, произнесённое с лишним словом.
