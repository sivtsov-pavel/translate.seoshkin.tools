...
const WIKI = {
  ru: {
    ...
    student: [
      ...
      {
        icon: '🤖', title: 'AI тренер — разговорные практики',
        body: 'Раздел «AI тренер» в меню — живые диалоги с персонажем-наставником.\n\nВыбери кого и о чём:\n🧑‍🏫 Лена (учительница), ☕ Макс (бариста), 🛒 Ганна (магазин), 🏨 Отто (отель)\nТемы: Знакомство, Кафе, Покупки, Отель, Ориентирование, Свободная беседа\n\nПерсонаж отвечает по-немецки — под сообщением:\n• Перевод на украинский\n• Твои ошибки с объяснением\n• Кнопка 🔊 прослушать правильное произношение\n\nМожно писать по-русски или по-украински — ИИ всё поймёт!',
      },
      {
